...
im = imread('E:\EAJ\2019\PDI\Aulas\Aula 9-Dominio Espacial\desmatamento.jpg');
...
imwrite(imLimiar, 'E:\EAJ\2019\PDI\Aulas\Aula 9-Dominio Espacial\imLimiar.jpg');

% logaritmo
im2 = imread('E:\EAJ\2019\PDI\Aulas\Aula 9-Dominio Espacial\degrade.jpg');
...
imshow(imLog);
imwrite(imLog, 'E:\EAJ\2019\PDI\Aulas\Aula 9-Dominio Espacial\imLog.jpg');
...
imshow(imPot);
imwrite(imPot, 'E:\EAJ\2019\PDI\Aulas\Aula 9-Dominio Espacial\imPot.jpg');
...
imshow(imFat1)
imwrite(imFat1, 'E:\EAJ\2019\PDI\Aulas\Aula 9-Dominio Espacial\imFat1.jpg');
...
imshow(imFat2)
imwrite(imFat2, 'E:\EAJ\2019\PDI\Aulas\Aula 9-Dominio Espacial\imFat2.jpg');
